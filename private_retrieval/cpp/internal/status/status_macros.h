...
#ifndef PRIVATE_RETRIEVAL_CPP_INTERNAL_STATUS_STATUS_MACROS_H_
#define PRIVATE_RETRIEVAL_CPP_INTERNAL_STATUS_STATUS_MACROS_H_
...
#endif  // PRIVATE_RETRIEVAL_CPP_INTERNAL_STATUS_STATUS_MACROS_H_
